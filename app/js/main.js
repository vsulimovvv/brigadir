...
// * ===== Slider
(function slider() {
  const sliderEl = document.querySelector('.products-stock__slider');
  new Swiper(sliderEl, {
    pagination: {
      el: document.querySelector('.products-stock__content .swiper-pagination'),
      type: 'progressbar',
    },
    slidesPerView: 'auto',
...
(function slider() {
  ...
  new Swiper(sliderEl, {
    ...
    pagination: {
      el: document.querySelector('.brands-slider__content .swiper-pagination'),
      type: 'progressbar',
    },
    breakpoints: {
      320: {
...
(function slider() {
  ...
  new Swiper(sliderEl, {
    slidesPerView: 1,
    navigation: {
      nextEl: document.querySelector('.new-slider__slider .swiper-button-next'),
      prevEl: document.querySelector('.new-slider__slider .swiper-button-prev'),
    },
  });
})();
